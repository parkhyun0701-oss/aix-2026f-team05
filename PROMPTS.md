...
#### 1건
- 무엇을 하려고 썼는가
> 문제의 원인을 나눠 보고, 우리 서비스가 해결할 범위를 정하기 위해

- 넣은 프롬프트 원문 그대로:
> 저장한 북마크를 다시 꺼내 쓰지 못하는 문제는 왜 일어나는지 원인을 정리해 줘

- 나온 것 중 쓴 것 / 버린 것:
> 쓴 것: "안 보이면 잊는다", "정리하지 못해 쌓여서 찾기 어렵다"는 원인
> 버린 것: "나중에 볼 것으로 미루는 습관"을 핵심 해결 대상으로 삼는 것

- 버렸다면 왜 버렸는가
> 미루는 습관 자체는 도구로 고치기 어려워 범위가 너무 커지기 때문. 대신 "나중에 볼 것" 그룹을 첫 화면에 보여주는 정도로만 반영함
